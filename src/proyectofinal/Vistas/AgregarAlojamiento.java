...
public class AgregarAlojamiento extends javax.swing.JFrame {
    ...
    private void cargarComboCiudades(){
        String provincias = (String) jcomboProvincia.getSelectedItem();
        String pais = (String) jcomboPais.getSelectedItem();
        
       List<Ciudad> ciu =  cData.listarCiudadPorProvinciaypais(pais, provincias);
